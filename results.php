<?php 
    ...
    $subtotal = $size * SMALL_SIZE + $meat * MEAT_TOPPING + $veggie * VEGGIE_TOPPING + $sauce * SAUCE + $extras * EXTRAS;
    $tax = $subtotal * TAX;
    $total = $subtotal + $tax;
    ...
    $subtotal = $size * MEDIUM_SIZE + $meat * MEAT_TOPPING + $veggie * VEGGIE_TOPPING + $sauce * SAUCE + $extras * EXTRAS;
    $tax = $subtotal * TAX;
    $total = $subtotal + $tax;
    ...
    $subtotal = $size * MONSTER_SIZE + $meat * MEAT_TOPPING + $veggie * VEGGIE_TOPPING + $sauce * SAUCE + $extras * EXTRAS;
    $tax = $subtotal * TAX;
    $total = $subtotal + $tax;
